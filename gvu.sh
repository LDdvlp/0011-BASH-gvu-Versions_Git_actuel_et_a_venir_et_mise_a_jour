...
# Updates Git for Windows
# Version from 2.14.2 to 2.16.1 : git update
# Version after 2.16.1 : git update-git-for-windows
# Source : https://www.tremplin-numerique.org/comment-verifier-et-mettre-a-jour-votre-version-de-git
